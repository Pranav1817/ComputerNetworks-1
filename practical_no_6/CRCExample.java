package practical_no_6;
// Output:
// Enter the size of the data 
// 7
// Enter data bits ( from msb) 
// 1 0 0 1 1 0 1
// Enter the length of generator function:- 
// 4
// Enter generator bits ( from msb) 
// 1 0 1 1
...
class CRCExample {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Enter data bits ( from msb) ");
        for(int i = 0 ; i < size ; i++) {
            data[i] = scan.nextInt();
        }
        // take the size of the divisor from the user
        System.out.println("Enter the length of generator function:- ");
        size = scan.nextInt();
        // declaration of the divisor array
        int divisor[] = new int[size];
        System.out.println("Enter generator bits ( from msb) ");
        for(int i = 0 ; i < size ; i++) {
